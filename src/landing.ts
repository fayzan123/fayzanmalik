...
const PROJECT_DETAILS: Record<string, ProjectDetail> = {
  'claude-workflow-composer': {
    label: 'Developer Tooling · Open Source · 5,700+ npm downloads · 36 stars',
